 ...
 *
 *   1. **Build time** — `tesserafin-design/scripts/generate-web-tokens.mjs` derives
 ...
 * `TesserafinTokens` object but the derived custom property still carries the value baked in at build
