 ...
 * docs/tesserafin/design-tesserafin-shell-and-routing.md §2.6/§5. There is deliberately
 * no `webServer` block: starting a Reefin server (dotnet + ffmpeg + media
 * library) is out of scope for the test runner. Point TESSERAFIN_E2E_BASE_URL at a
 * running instance; credentials come from TESSERAFIN_E2E_USER / TESSERAFIN_E2E_PASSWORD.
 */
export default defineConfig({
    ...
    reporter: [['list']],
    use: {
        baseURL: process.env.TESSERAFIN_E2E_BASE_URL ?? 'http://localhost:8096',
