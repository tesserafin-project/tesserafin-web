...
Clicking a card or a link is browser navigation, not a route-owned outward call. Two things are
asserted, and a third deliberately is not.

**Asserted.** Every rendered anchor matches exactly one rule below — by `selector` where the rule
has one, otherwise by the section it sits in — so an anchor appearing in a surface no rule names
fails. And no anchor URL carries a **media-source id**: a link is always to an ITEM, never to one
of its sources.

**Not asserted.** Presence. Most of these surfaces are data-dependent — a class whose item lists no
studio renders no studio link — so a rule with no matching anchor is a classification that did not
apply, not a defect. That is the one direction the navigation rows are weaker than the request rows.

| Class | Affordance | Section | Selector | URL shape | Target | Note |
| --- | --- | --- | --- | --- | --- | --- |
...
| `movie` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `movie-resumable` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `movie-grouped-admin` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `movie-grouped-regular` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `minimal-video` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `series` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `season` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `episode` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `music-album` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `audio` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `music-artist` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `playlist` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `box-set` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `person` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `book` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `photo` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `program` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `recording` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `recording-no-livetv` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `series-timer` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `series-timer-no-livetv` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `tv-channel` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `genre` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
...
| `music-genre` | `cards.itemLinks` | `(any card-bearing section)` | `a.rf-media-card` | `#/details?id=<id>&serverId=<serverId>` | the CHILD item id — never this route's item id | rendered by ui MediaCard; clicking is browser navigation, not a route-owned outward call |
