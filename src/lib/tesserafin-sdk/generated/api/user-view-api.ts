...
/**
 * UserViewApi - interface
 * @export
 * @interface UserViewApi
 */
export interface UserViewApiInterface {
    /**
     * 
     * @summary Get user view grouping options.
     * @param {UserViewApiGetGroupingOptionsRequest} requestParameters Request parameters.
 ...
 * @export
 * @interface UserViewApiGetGroupingOptionsRequest
 */
export interface UserViewApiGetGroupingOptionsRequest {
    /**
     * User id.
     * @type {string}
     * @memberof UserViewApiGetGroupingOptions
     */
...
export interface UserViewApiGetUserViewsRequest {
     ...
     * User id.
     * @type {string}
     * @memberof UserViewApiGetUserViews
     */
    readonly userId?: string
 ...
 * @extends {BaseAPI}
 */
export class UserViewApi extends BaseAPI implements UserViewApiInterface {
    /**
     * 
     * @summary Get user view grouping options.
     * @param {UserViewApiGetGroupingOptionsRequest} requestParameters Request parameters.
