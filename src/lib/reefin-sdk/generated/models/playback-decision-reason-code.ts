...
/**
 * A closed, stable, string-serialized reason code identifying a single leaf fact in a Reefin.Playback.Decision.ReasonNode tree. The constraint members mirror `Reefin.Model.Session.TranscodeReason` one-to-one (that flags enum lists which walls a legacy decision hit, without saying why); the positive/decision members and Reefin.Playback.Decision.ReasonCode.NoViablePlan have no legacy equivalent.
 * @export
 * @enum {string}
 */
