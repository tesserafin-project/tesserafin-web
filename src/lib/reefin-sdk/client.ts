 ...
 * to *build* a `ReefinApi` (notably `utils/jellyfin-apiclient/compat.ts`, reached eagerly from
 ...
 *
 * `index.ts` re-exports everything here, so the public `lib/reefin-sdk` surface is unchanged.
