...
declare module 'jellyfin-apiclient' {
    ...
    class ApiClient {
        ...
        getLiveTvSeriesTimers(
            options?: any
        ): Promise<SeriesTimerInfoDtoQueryResult>;
        ...
        getQuickConnect(
            ...
            void | boolean | number | QuickConnectResult | QuickConnectState
        >;
        ...
        requestSyncPlayMovePlaylistItem(
            options?: MovePlaylistItemRequestDto
        ): Promise<void>;
        ...
        requestSyncPlayPreviousItem(
            options?: PreviousItemRequestDto
        ): Promise<void>;
        ...
        requestSyncPlayRemoveFromPlaylist(
            options?: RemoveFromPlaylistRequestDto
        ): Promise<void>;
        requestSyncPlaySeek(options?: SeekRequestDto): Promise<void>;
        requestSyncPlaySetIgnoreWait(
            options?: IgnoreWaitRequestDto
        ): Promise<void>;
        requestSyncPlaySetNewQueue(options?: NewGroupRequestDto): Promise<void>;
        requestSyncPlaySetPlaylistItem(
            options?: SetPlaylistItemRequestDto
        ): Promise<void>;
        requestSyncPlaySetRepeatMode(
            options?: SetRepeatModeRequestDto
        ): Promise<void>;
        requestSyncPlaySetShuffleMode(
            options?: SetShuffleModeRequestDto
        ): Promise<void>;
