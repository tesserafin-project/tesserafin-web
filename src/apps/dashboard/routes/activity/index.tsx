...
export const Component = () => {
    ...
    const activityParams = useMemo(() => {
        ...
        const mapSortField = (id: string): ActivityLogSortBy => {
            switch (id) {
                case 'Date':
                    return ActivityLogSortBy.DateCreated;
                case 'Severity':
                    return ActivityLogSortBy.LogSeverity;
                case 'Name':
                    return ActivityLogSortBy.Name;
                case 'Type':
                    return ActivityLogSortBy.Type;
                case 'Overview':
                    return ActivityLogSortBy.ShortOverview;
                case 'User':
                    return ActivityLogSortBy.Username;
                default:
                    return ActivityLogSortBy.DateCreated;
            }
        };
        ...
        return {
            ...
            minDate:
                (getFilter('Date') as string[] | undefined)?.[0] ?? undefined,
            maxDate:
                (getFilter('Date') as string[] | undefined)?.[1] ?? undefined,
            sortBy: sortFields,
