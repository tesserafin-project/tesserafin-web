...
import type {
    ...
    PlayerStopInfo,
    RemovedItems
} from 'apps/legacy/features/playback/types/callbacks';
...
export abstract class PlaybackSubscriber {
    ...
    private readonly playbackManagerEvents = {
        [PlaybackManagerEvent.PlaybackCancelled]:
            this.onPlaybackCancelled?.bind(this),
    ...
    private readonly playerEvents = {
        ...
        [PlayerEvent.PlaylistItemMove]:
            this.onPlayerPlaylistItemMove?.bind(this),
        [PlayerEvent.PlaylistItemRemove]:
            this.onPlayerPlaylistItemRemove?.bind(this),
        [PlayerEvent.PromptSkip]: this.onPromptSkip?.bind(this),
        [PlayerEvent.RepeatModeChange]:
            this.onPlayerRepeatModeChange?.bind(this),
        [PlayerEvent.ShuffleModeChange]:
            this.onPlayerShuffleModeChange?.bind(this),
    ...
    constructor(protected readonly playbackManager: PlaybackManager) {
        ...
        Object.entries(this.playbackManagerEvents).forEach(
            ([event, handler]) => {
