...
export default tseslint.config(
    ...
    // Global ignores
    {
        ignores: [
            ...
            '.idea',
            '.vscode',
            // Generated by `npm run generate:reefin-sdk` (openapi-generator-cli) - not hand-written,
            // regenerated wholesale on every run. See src/lib/reefin-sdk/README.md.
            'src/lib/reefin-sdk/generated'
        ]
    },
